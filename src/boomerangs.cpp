...
Boomerangs::Boomerangs(float x, float y, color_t color) {
    ...
    vertex_buffer_data[vertex_count++]=0.5f;
...
void Boomerangs::draw(glm::mat4 VP) {
...
void Boomerangs::set_position(float x, float y) {
    this->position = glm::vec3(x, y, 0);
}

void Boomerangs::tick() {
    this->rotation += 2;
